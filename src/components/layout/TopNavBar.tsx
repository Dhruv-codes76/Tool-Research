...
const TopNavBar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-surface/80 dark:bg-surface/80 backdrop-blur-md border-b border-outline-variant/20">
      <div className="relative flex justify-between items-center max-w-container-max mx-auto px-gutter h-16">
        ...
        <div className="hidden md:flex items-center gap-stack-md font-body-base text-body-base absolute left-1/2 -translate-x-1/2">
          <Link
            href="/"
